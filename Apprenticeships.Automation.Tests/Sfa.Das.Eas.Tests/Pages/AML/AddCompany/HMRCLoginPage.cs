...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.AML
{
...

    {
        ...
        [FindsBy(How = How.Id, Using = "userId")] private IWebElement UserNameTextBox { get; set; }
        [FindsBy(How = How.Id, Using = "password")] private IWebElement PasswordTextBox { get; set; }
        [FindsBy(How = How.XPath, Using = "//*[@id=\"content\"]/div[4]/input")] private IWebElement SignInButton { get; set; }
        [FindsBy(How = How.XPath, Using = ".//*[@id=\'content\']/div[2]/article/form/fieldset/div/input")] private IWebElement GrantAuthorityButton { get; set; }
        [FindsBy(How = How.XPath, Using = ".//*[@id=\'continue\']")] private IWebElement TheseDetailsAreCorrectButton { get; set; }
