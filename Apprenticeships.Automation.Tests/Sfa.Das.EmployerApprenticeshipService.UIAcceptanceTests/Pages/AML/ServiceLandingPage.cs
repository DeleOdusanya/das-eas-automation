...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.AML
{
    public class ServicesLandingPage : SfaBasePage
    {
        ...
        [FindsBy(How = How.Id, Using = "add_new_account")] private IWebElement AddAccountBtn { get; set; }
        // [FindsBy(How = How.LinkText, Using = "Open")] private IWebElement OpenAccountLink{ get; set; }
