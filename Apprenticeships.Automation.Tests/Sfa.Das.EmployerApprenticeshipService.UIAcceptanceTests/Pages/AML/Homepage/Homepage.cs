...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.AML
{
    public class Homepage : SfaBasePage
    {
        ...
        [FindsBy(How = How.Id, Using = "harything")] private IWebElement YesIHaveEverythingINeed { get; set; }
        [FindsBy(How = How.Id, Using = "do-not-have-evve-eveerything")] private IWebElement NoIDontHaveEverythingINeed { get; set; }
        [FindsBy(How = How.Id, Using = "submit-button")] private IWebElement WhatYouNeedContinue { get; set; }
