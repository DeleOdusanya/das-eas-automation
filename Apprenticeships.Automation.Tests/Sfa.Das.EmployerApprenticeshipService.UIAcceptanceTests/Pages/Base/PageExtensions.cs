...
using Sfa.Das.EAS.AcceptanceTests.Pages.AML.CreateAccount;
...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.Base
{
    ...
    internal static class PageExtensions
    {
        ...
        internal static SignInPage SignInPage(this IWebDriver webDriver)
        {
        ...
        internal static SelectEmployer SearchForCompanyPage(this IWebDriver webDriver)
        {
            return new SelectEmployer(webDriver);
        }

        //internal static ChangeRolePage ChangeRolePage(this IWebDriver webDriver)
        //{
        //    return new ChangeRolePage(webDriver);
        //}

        //internal static TeamMemberDetailsPage TeamMemberDetailsPage(this IWebDriver webDriver)
        //{
        //    return new TeamMemberDetailsPage(webDriver);
        //}
        ...
        internal static WhatYoullNeed WhatYoullNeed(this IWebDriver webDriver)
        {
            return new WhatYoullNeed(webDriver);
        }

        internal static ForgottenCredentialsPage ForgottenCredentialsPage(this IWebDriver webDriver)
        {
            return new ForgottenCredentialsPage(webDriver);
        }

        internal static ConfirmYourIdentityPage ConfirmYourIdentityPage(this IWebDriver webDriver)
        {
            return new ConfirmYourIdentityPage(webDriver);
        }

        internal static SelectEmployer SelectEmployer(this IWebDriver webDriver)
        {
            return new SelectEmployer(webDriver);
        }

        //internal static YourTeamPage YourTeamPage(this IWebDriver webDriver)
        //{
        //    return new YourTeamPage(webDriver);
        //}
