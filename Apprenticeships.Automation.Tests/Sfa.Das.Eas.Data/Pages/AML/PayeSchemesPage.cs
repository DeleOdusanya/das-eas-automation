...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.AML
{
    public class PAYESchemesPage : SfaBasePage
    {
        ...
        [FindsBy(How = How.Id, Using = "addNewPaye")] private IWebElement AddNewPayeeBtn;
        [FindsBy(How = How.LinkText, Using = "Details")] private IWebElement DetailsLink;
        [FindsBy(How = How.Id, Using = "agree_and_continue")] private IWebElement AddPAYEAgreeAndContinueBtn;
