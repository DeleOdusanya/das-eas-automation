...
namespace Sfa.Das.EAS.AcceptanceTests.Pages.AML
{
    public class YourTeamPage : SfaBasePage
    {
        ...
        [FindsBy(How = How.Id, Using = "addNewUser")] private IWebElement addNewUserBtn;
        [FindsBy(How = How.XPath, Using = ".//*[@id='content']/div[3]/div/table/tbody/tr/td[4]/a")] private IWebElement ViewLink;
       
        internal CreateInvitationPage AddNewMember()
        {
